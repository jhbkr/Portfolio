  ...
  const sections = [
    {
      ...
      content: [
        "Passionné par le développement web, à la recherche d'une alternance en Novembre 2025 pour approfondir ses compétences en Full-Stack.",
    ...
    <section id="about" className="py-24 md:py-32">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4">À propos de Jihad Bakari</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Découvrez le parcours, les compétences et la personnalité de Jihad Bakari, développeur web et mobile à Lyon.
          </p>
        </motion.div>
